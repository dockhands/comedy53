...
class TwitterProxy {
	 ...
	 *  @param	string  $ignore_replies       => true, // Ignore @replies
     *  @param	string  $ignore_retweets       => true, // Ignore retweets
	 */
	public function __construct($oauth_access_token, $oauth_access_token_secret, $consumer_key, $consumer_secret, $user_id, $screen_name, $count = 5, $ignore_replies, $ignore_retweets  ) {

		$this->config = array_merge($this->config, compact('oauth_access_token', 'oauth_access_token_secret', 'consumer_key', 'consumer_secret', 'user_id', 'screen_name', 'count', 'replies', 'retweets'));
