            ...
            function parseTableHtml(s) { // s is string
                ...
                for(j=0; j < moviesLength; j++){
                    ...
                    if(movieLink.search("2010") > 0 || movieLink.search("2011/01") > 0){
                        if(movieLink.search("pauline") > 0 || movieLink.search("milk") > 0 || movieLink.search("carrie") > 0 || movieLink.search("brazil") > 0 || movieLink.search("king-of-comedy") > 0 || movieLink.search("nosferatu") > 0 || movieLink.search("this-is-england") > 0 || movieLink.search("hardcore") > 0 || movieLink.search("dont-look") > 0 || movieLink.search("breathless") > 0 || movieLink.search("the-fly") > 0 || movieLink.search("temptation") > 0 || movieLink.search("rosemarys") > 0 || movieLink.search("adventureland") > 0 || movieLink.search("five-easy-pieces") > 0 || movieLink.search("buffalo") > 0 || movieLink.search("aguirre") > 0 || movieLink.search("hired-hand") > 0 || movieLink.search("wendy-and") > 0 || movieLink.search("brick") > 0 || movieLink.search("indian-runner") > 0 || movieLink.search("eternal-sunshine") > 0 || movieLink.search("woyzeck") > 0 || movieLink.search("easy-rider") > 0 ){
